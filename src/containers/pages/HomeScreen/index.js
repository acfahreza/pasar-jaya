...
class HomeScreen extends Component {
  ...
  render() {
    ...
    const filterData = data1.filter((data) => data.title === type);
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <View style={{marginLeft: 5, marginRight: 5, marginTop: 5}}>
                ...
                <Text style={{fontSize: 20, color: '#8C8585'}}>
                  {data.title}
                </Text>
                <Text
                  style={{
                ...
                <Text
                  style={{fontSize: 20, color: '#555555', fontWeight: 'bold'}}>
                  Rp {data.harga}
                </Text>
              </View>
            </TouchableOpacity>
    ...
    return (
      <View
        ...
        <ScrollView
          ...
          <MainFeature activeTab={active} changeTab={this.handleChangeTab} />
